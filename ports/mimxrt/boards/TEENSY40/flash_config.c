...
// Config for W25JV16UXIM with QSPI routed.
const flexspi_nor_config_t qspiflash_config = {
    .memConfig =
    {
        ...
        .lookupTable =
        {
            ...
            FLEXSPI_LUT_SEQ(DUMMY_SDR, FLEXSPI_4PAD, 32, READ_SDR, FLEXSPI_4PAD, 0x04),
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler

            // 7 Read ID
            FLEXSPI_LUT_SEQ(CMD_SDR, FLEXSPI_1PAD, 0x90, DUMMY_SDR, FLEXSPI_1PAD, 16),
            FLEXSPI_LUT_SEQ(RADDR_SDR, FLEXSPI_1PAD, 8, READ_SDR, FLEXSPI_1PAD, 0x00),
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
