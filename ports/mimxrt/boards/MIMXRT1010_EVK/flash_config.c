...
const flexspi_nor_config_t qspiflash_config = {
    .memConfig =
    {
        ...
        .lookupTable =
        {
            ...
            FLEXSPI_LUT_SEQ(CMD_SDR, FLEXSPI_1PAD, 0x35, READ_SDR, FLEXSPI_1PAD, 0x01),
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
            ...
            // 4 Write Status Reg: Enable Quad mode
            ...
            FLEXSPI_LUT_SEQ(READ_SDR, FLEXSPI_1PAD, 0x00, STOP, FLEXSPI_1PAD, 0),
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
            ...
            FLEXSPI_LUT_SEQ(WRITE_SDR, FLEXSPI_1PAD, 0, STOP, FLEXSPI_1PAD, 0),
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
            FLEXSPI_LUT_SEQ(0, 0, 0, 0, 0, 0),         // Filler
